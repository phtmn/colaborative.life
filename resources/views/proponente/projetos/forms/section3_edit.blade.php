        ...
        <div class="col-md-9">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <input type="text" name="ag" class="form-control" value="{{$projeto->ag}}" placeholder="Agência" >                    
                </div>
                <div class="form-group col-md-3">
                    <input type="text" name="cc" class="form-control" value="{{$projeto->cc}}" placeholder="Conta" >                                       
                </div>
            </div>
        </div>
    </div>
